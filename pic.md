...
界面布局：左右两个池子并排，每个池子下方有单抽/十连按钮和保底进度条。
...
| `gacha_animation_bg.png` | 抽卡过场动画背景 | 1380×820 |
| `gacha_light_1.png` | 抽卡光效——普通 | 300×300 |
| `gacha_light_2.png` | 抽卡光效——稀有（大奖） | 400×400 |
| `gacha_card_tank.png` | 结果卡——新坦克 | 120×170 |
| `gacha_card_mod.png` | 结果卡——改装碎片 | 100×140 |
| `gacha_card_resource.png` | 结果卡——生铁/钢铁 | 100×120 |
